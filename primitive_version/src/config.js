...
export const GRID = {
  ...
  cellsY: 13,
  cellSize: 1.1,
  pillarSize: 0.5, // footprint of each of the 4 mini pillars inside a cell —
  // nudged up (was 0.46) to fill more of each cell, per feedback ("maior
  // tamanho de pilar que der para encaixar").
  pillarGap: 0.02, // tiny gap so the 4 pillars still read as separate pieces
...
export const PIG = {
  ammoStart: 20, // shots a pig starts with (fixed, matches reference)
  ...
  minBeltGap: 2.9, // minimum arc-length distance kept between two pigs on
...
export const TILE = {
  ...
  color: 0xcdab7d, // neutral warm tone standing in for the future wood raft
  enterDuration: 0.18, // seconds for the "push fiche onto the belt" entry
...
export const LIGHTING = {
  ...
  // shadow.
  sunColor: 0xfff1d0,
  sunPosition: { x: 7, y: 9.9, z: -7 }, // v1r: moved to screen top-right
  ...
  sunIntensity: 2.1, // bumped up (was 1.75) for a stronger "sol tropical...
  // forca de sol de meio dia" feel, per feedback.
  ambientIntensity: 0.9, // bumped slightly alongside sunIntensity so the
  // overall scene reads brighter/tropical rather than just harsher-shadowed.
  shadowMapSize: 1024,
};
...
export const COLORS = {
  ...
  track: 0x3f456f,
  trackArrow: 0x8fe3ff,
  pillarWhite: 0xffffff,
  pillarBlack: 0x0c0c12,
  pigWhite: 0xf5f5f5,
  pigBlack: 0x24242c,
  pigEarWhite: 0xd9d9de,
  pigEarBlack: 0x14141a,
  snout: 0xff9db3,
  eye: 0x14162a,
  leg: 0x2a2a34,
  trayBody: 0x2a2e52,
  trayCardEmpty: 0x3a3f6b,
  projectileWhite: 0xffffff,
  projectileBlack: 0xf4f4fa, // "mais branco" — near-white even for black pigs
